...
class getHelloControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Service/DiceRollService.php';
        include_once \dirname(__DIR__, 4).'/src/Service/CoinFlipService.php';

        $container->services['App\\Controller\\HelloController'] = $instance = new \App\Controller\HelloController(new \App\Service\DiceRollService(), new \App\Service\CoinFlipService());
